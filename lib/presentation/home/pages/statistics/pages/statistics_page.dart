...
class _StatisticsPageState extends State<StatisticsPage> {
  ...
  final controller2 = Get.find<CreateTeamController>();
        ...
        body: Stack(
          children: [
            ...
            SingleChildScrollView(
              ...
              const Row(children: [
                DropdownBut(text: "Positsiya"),
                DropdownBut(text: "Klub"),
              ],),
                  ...
                  ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return PlayerStatisticWidget(data:  homeMenuItems[0], controller: controller, index: index,);
                      },
